            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="relative h-56 mt-auto">
                  <style jsx>{`
                    @keyframes drop1 {
                      0% { transform: translateY(-120px) translateX(30px) rotate(0deg); }
                      60% { transform: translateY(0px) translateX(0px) rotate(-8deg); }
                      70% { transform: translateY(-8px) translateX(-3px) rotate(-12deg); }
                      80% { transform: translateY(0px) translateX(2px) rotate(-5deg); }
                      90% { transform: translateY(-3px) translateX(0px) rotate(-7deg); }
                      100% { transform: translateY(0px) translateX(0px) rotate(-8deg); }
                    }
                    @keyframes drop2 {
                      0% { transform: translateY(-140px) translateX(-25px) rotate(0deg); }
                      60% { transform: translateY(0px) translateX(0px) rotate(10deg); }
                      70% { transform: translateY(-8px) translateX(4px) rotate(14deg); }
                      80% { transform: translateY(0px) translateX(-2px) rotate(8deg); }
                      90% { transform: translateY(-3px) translateX(1px) rotate(9deg); }
                      100% { transform: translateY(0px) translateX(0px) rotate(10deg); }
                    }
                    @keyframes drop3 {
                      0% { transform: translateY(-130px) translateX(40px) rotate(0deg); }
                      60% { transform: translateY(0px) translateX(0px) rotate(-12deg); }
                      70% { transform: translateY(-8px) translateX(-4px) rotate(-16deg); }
                      80% { transform: translateY(0px) translateX(3px) rotate(-10deg); }
                      90% { transform: translateY(-3px) translateX(-1px) rotate(-11deg); }
                      100% { transform: translateY(0px) translateX(0px) rotate(-12deg); }
                    }
                    @keyframes drop4 {
                      0% { transform: translateY(-150px) translateX(-35px) rotate(0deg); }
                      60% { transform: translateY(0px) translateX(0px) rotate(9deg); }
                      70% { transform: translateY(-8px) translateX(3px) rotate(13deg); }
                      80% { transform: translateY(0px) translateX(-2px) rotate(7deg); }
                      90% { transform: translateY(-3px) translateX(1px) rotate(8deg); }
                      100% { transform: translateY(0px) translateX(0px) rotate(9deg); }
                    }
                    @keyframes drop5 {
                      0% { transform: translateY(-160px) translateX(20px) rotate(0deg); }
                      60% { transform: translateY(0px) translateX(0px) rotate(-7deg); }
                      70% { transform: translateY(-8px) translateX(-3px) rotate(-10deg); }
                      80% { transform: translateY(0px) translateX(2px) rotate(-5deg); }
                      90% { transform: translateY(-3px) translateX(0px) rotate(-6deg); }
                      100% { transform: translateY(0px) translateX(0px) rotate(-7deg); }
                    }
                  `}</style>
                  <div className="absolute bottom-0 left-2" style={{ animation: "drop1 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0s forwards" }}>
                    <div className="w-16 h-16 bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 border-2 border-gray-300 rounded-2xl flex items-center justify-center shadow-lg" style={{ boxShadow: "0 4px 12px rgba(0,0,0,0.1), inset 0 2px 4px rgba(255,255,255,0.8)" }}>
                  ...
                  <div className="absolute bottom-0 right-2" style={{ animation: "drop2 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s forwards" }}>
                    <div className="w-16 h-16 bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 border-2 border-gray-300 rounded-2xl flex items-center justify-center shadow-lg" style={{ boxShadow: "0 4px 12px rgba(0,0,0,0.1), inset 0 2px 4px rgba(255,255,255,0.8)" }}>
                  ...
                  <div className="absolute bottom-0 left-1/4" style={{ animation: "drop4 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.6s forwards" }}>
                    <div className="w-16 h-16 bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 border-2 border-gray-300 rounded-2xl flex items-center justify-center shadow-lg" style={{ boxShadow: "0 4px 12px rgba(0,0,0,0.1), inset 0 2px 4px rgba(255,255,255,0.8)" }}>
                      <svg viewBox="0 0 24 24" className="w-9 h-9" fill="none">
                  ...
                  <div className="absolute bottom-0 right-1/4" style={{ animation: "drop5 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.8s forwards" }}>
                    <div className="w-16 h-16 bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 border-2 border-gray-300 rounded-2xl flex items-center justify-center shadow-lg" style={{ boxShadow: "0 4px 12px rgba(0,0,0,0.1), inset 0 2px 4px rgba(255,255,255,0.8)" }}>
                      <svg viewBox="0 0 24 24" className="w-9 h-9" fill="none">
