  ...
  const screens = [
    {
      ...
      problem: "Managers found out about access problems only when security escalated or an auditor raised a finding. There was no proactive surface.",
      decision: "Most tools answer \"how bad is it?\" This one answers \"what do I do right now?\"",
      insight: "91% of managers had no visibility into their team's access health. The five KPIs map directly to what they were checking manually every morning — across emails, Slack, and spreadsheet tabs.",
