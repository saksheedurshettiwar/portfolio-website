...
export default function AccessIQCaseStudy() {
  ...
  const screens = [
    ...
    },
    {
      ...
      problem: "Employees had no self-service way to manage access. Everything went through the manager via Slack or email — and when access expired silently, they found out only when they got locked out.",
      decision: "Every catalogue action leads to the same simple modal — two decisions only: how long, and why. Current access is shown at the top so employees know what they already have before they submit.",
      insight: "Showing the expiry warning inside the modal let employees extend access themselves in under 60 seconds — eliminating the wave of emergency Slack messages managers received every time someone got locked out.",
      insightLabel: "Research insight",
