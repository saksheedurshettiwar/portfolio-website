  ...
  const screens = [
    {
      ...
      decision: "Most tools answer \"how bad is it?\" This one answers \"what do I do right now?\" Five KPIs replace the manual Slack messages, emails, and spreadsheet tabs managers were juggling every morning.",
      insight: "91% of managers had no consolidated view of their team's access. The KPIs weren't pulled from a compliance checklist — they came from what managers said they were already trying to track themselves.",
